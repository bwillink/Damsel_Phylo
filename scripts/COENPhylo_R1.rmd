...
```{r codon-saturation, echo=TRUE, eval=TRUE, fig.width=8, fig.height=4}
...
```{r plot-map-support, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE, fig.width=8, fig.height=12}
# Read MAP tree
...
```{r clade-compare, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE, fig.width=8, fig.height=6}
# read trees
...
```{r plot-extant, echo=TRUE, eval=TRUE, message=FALSE, fig.width=8, fig.height=8}
# plot phylogeny
...
pie_data <- pie_data %>% mutate(others= `1` + `8`+  A + E + G + N + `2`)
...
```{r plot-all, eval=TRUE, echo=TRUE, message=FALSE, warning=FALSE,results='hide', fig.width=8, fig.height=12}
...
```{r plot-by-clade,  eval=TRUE, echo=TRUE, message=FALSE, warning=FALSE,results='hide', fig.width=8, fig.height=12}
p3 <-
...
```{r plot-ridge, fig.width=8, fig.height=12}
gridge <-
...
Plot Core clade.
```{r plot-core, fig.width=8, fig.height=12}
gcore <-
  viewClade(g3, getMRCA(Map_strong@phylo, tip = c(
...
```{bash run-EBED, echo=TRUE, eval=FALSE}
#!/bin/bash
...
```{r plot-HiSSE, message=FALSE, warning=FALSE,  fig.width=8, fig.height=8}
...
```{r biome-spe-summ, echo=TRUE, eval=TRUE, message=FALSE}
spe_wide <- H_out %>%
...
```{r biome-ext-summ, echo=TRUE, eval=TRUE, message=FALSE}
ext_wide <- H_out %>%
...
```{r biome-div-summ, echo=TRUE, eval=TRUE, message=FALSE}
div_wide <- H_out %>%
...
```{r biome-trn-summ, echo=TRUE, eval=TRUE, message=FALSE}
trn_wide <- H_out %>%
...
```{r plot-ancestral-biome, echo=TRUE, eval=TRUE, message=FALSE, fig.width=8, fig.height=8}
...
```{r plot-HiSSE-prior, message=FALSE, warning=FALSE, fig.width=8, fig.height=8}
# create data frame for combined posterior
...
```{r create-adjacency-plots, echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE}
...
```{r plot-adjacency-matrices, echo=TRUE, eval=TRUE, message=FALSE, results='hide', fig.width=10, fig.height=8}
...
```{r plot-biome-ase, echo=TRUE, eval=TRUE, message=FALSE, fig.width=8, fig.height=12}
# path objects
fp = "../"
...
```{r prep-lstt-plot, eval=TRUE, echo=TRUE, warning=FALSE, message=FALSE, results='hide'}
# path objects
fp = "../"
...
```{r plot-lstt, eval=TRUE, echo=TRUE, warning=FALSE, message=FALSE, results='hide', fig.width=12, fig.height=8}
...
```{r plot lstt-matchig, eval=TRUE, echo=TRUE, warning=FALSE, fig.width=12, fig.height=8}
...
```{r prep-event-plot, eval=TRUE, echo=TRUE, warning=FALSE, message=FALSE}
# filesystem
fp       = "../"
plot_fp  = paste0(fp, "output/biome_shift/plot/")
...
```{r prep-event-data, eval=TRUE, echo=TRUE, warning=FALSE, message=FALSE,results='hide'}
# process data
d_raw = list()
d_param = list()
d_trip = list()
...
```{r plot-events, eval=TRUE, echo=TRUE, warning=FALSE, fig.width=12, fig.height=12}
...
```{r plot-old-w, message=FALSE, warning=FALSE}
# get posterior distributions of ancestral states for the key ancestral nodes  
...
# combine all the rare states into "others"
pie_data <- pie_data %>% mutate(others= `1` + `7` + `8`+  A + E  + N + `2`)
...
```{r plot-all-w, eval=TRUE, echo=TRUE, message=FALSE, warning=FALSE,results='hide', fig.width=8, fig.height=12}
DF_anc <- DF[which(DF$node > 669),]
...
Create plot with tip labels.
```{r plot-by-clade-w,  eval=TRUE, echo=TRUE, message=FALSE, warning=FALSE,results='hide', fig.width=8, fig.height=8}
p3 <-
...
Plot Featherleg clade.
```{r plot-featherlegs-w, fig.width=8, fig.height=12}
gfeather <-
...
Plot Ridge-face clade.
```{r plot-ridge-w, fig.width=8, fig.height=12}
gridge <-
...
Plot Core clade.
```{r plot-core-w, fig.width=8, fig.height=12}
gcore <-
  viewClade(g3, getMRCA(Map_weak@phylo, tip = c(
    "Coenagrion_scitulum", "Acanthagrion_gracile"
  )))
